...
imageTheme: "vscode.png"
title: "Mi configuración de VSCode"
description: "Esta es la principal configuración que tengo en cuanto a opciones, temas, iconos, etc en VSCode"
pubDate: "2022/08/23"
...
Hay una infinidad de opciones que se pueden cambiar en VSCode, además de que también se puede cambiar la configuración de las extensiones. Para cambiar la configuración de forma rápida podemos acceder a un json con toda la personalización del editor usando `ctrl + ,` y haciendo clic en <img style="position: relative; top: 3px" src="/mi-configuracion-de-VSCode/confi.png" />. A continuación está la configuración que tengo para VSCode.
